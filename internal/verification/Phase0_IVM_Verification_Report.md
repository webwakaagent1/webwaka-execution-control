...
*   **What assumptions were implicit but undocumented?**
    ...
    4.  **The choice of `af-south-1` was fully vetted:** I had to assume that the choice of the AWS region was made after considering all service availability trade-offs. The fact that a core service like Bedrock is not available there was a surprise that should have been explicitly documented with its corresponding architectural solution (i.e., cross-region calls).
